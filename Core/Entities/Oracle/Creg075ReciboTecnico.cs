...
namespace Core.Entities.Oracle
{
    public partial class Creg075ReciboTecnico
    {
        ...
        public virtual CregPersonaAutoriza CodPersonaAutorizacion { get; set; }
        public virtual CregTipoCompletitud CodTipoCompletitud { get; set; }
        public virtual CregTipoSolicitudRecibo CodTipoSolicitud { get; set; }
        public Creg075ServicioConexion Cod075Conexion { get; set; }
