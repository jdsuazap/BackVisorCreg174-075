...
{
    public partial class Ciudad : StringBaseEntity
    {
        public Ciudad()
        {
            SolConexionAutogens = new HashSet<SolConexionAutogen>();
            SolConexionAutogenInmuebles = new HashSet<SolConexionAutogenInmueble>();
        ...
        public virtual ICollection<SolConexionAutogenInmueble> SolConexionAutogenInmuebles { get; set; }
