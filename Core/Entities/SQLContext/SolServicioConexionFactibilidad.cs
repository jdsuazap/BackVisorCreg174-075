...
{
    public partial class SolServicioConexionFactibilidad : GenericBaseEntity<long>
    {
        ...
        public virtual ICollection<SolServicioConexionDisenio> SolServicioConexionDisenios { get; set; } = new List<SolServicioConexionDisenio>();
    }
}
