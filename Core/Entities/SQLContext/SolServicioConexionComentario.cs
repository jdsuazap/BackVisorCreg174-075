...
{
    public partial class SolServicioConexionComentario : BaseEntity
    {
        public SolServicioConexionComentario()
        {
            InverseCodSolServicioConexionComentarioNavigation = new HashSet<SolServicioConexionComentario>();
        }
        ...
        public virtual SolServicioConexionComentario? CodSolServicioConexionComentarioNavigation { get; set; }
        public virtual SolServicioConexion CodSolServicioConexionNavigation { get; set; } = null!;
        public virtual ICollection<SolServicioConexionComentario> InverseCodSolServicioConexionComentarioNavigation { get; set; }
    }
}
