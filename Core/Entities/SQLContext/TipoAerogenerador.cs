...
{
    public partial class TipoAerogenerador : BaseEntity
    {
        public TipoAerogenerador()
        {
            SolConexionAutogenInfoEolicas = new HashSet<SolConexionAutogenInfoEolica>();
        }
        ...
        public virtual ICollection<SolConexionAutogenInfoEolica> SolConexionAutogenInfoEolicas { get; set; }
    }
}
