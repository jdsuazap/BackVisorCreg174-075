namespace Core.Services.SQLContext
{
    ...
    public class SolConexionAutogenService : ISolConexionAutogenService
    {
        ...
        private List<SolConexionAutogenAnexo> ListDocuments = new List<SolConexionAutogenAnexo>(); // listado de archivos que se guardarán en DB
        private readonly PathOptions _pathOptions;
        private SolConexionAutogen Entity = null!;
        ...
        public async Task<SolConexionAutogen> GetEntity(SolConexionAutogen entity)
        {
            ...
            solicitud.SolConexionAutogenTecnUtilizada = await GetTecnologiasUtilBySolicitud(idEntity);

            solicitud.SolConexionAutogenAnexos = await GetAnexosBySolicitud(idEntity);

            //solicitud.SolConexionAutogenContratoAnexos = await GetContratoConexionAnexosBySolicitud(idEntity);

            //solicitud.SolConexionAutogenDocumentacionRetieRechazos = await GetDocumentacionRetieRechazoBySolicitud(idEntity);

            //solicitud.SolConexionAutogenAnexoRechazos = await GetAnexoRechazosBySolicitud(idEntity);

            //solicitud.SolConexionAutogenInsumos = await GetInsumoBySolicitud(idEntity);

            //solicitud.SolConexionAutogenViabilidadTecnicaRechazos = await GetViabilidadTecnicaRechazos(idEntity);

            solicitud.PasosSolConexionAutogens = await GetPasosBySolicitud(idEntity);

            //solicitud.SolConexionAutogenXprorrogas = await GetProrrogaBySolicitud(idEntity);

            //solicitud.SolConexionAutogenDocumentacionVisita = await GetDocVisitaBySolicitud(idEntity);
            ...
            //solicitud.SolConexionAutogenConexionRechazos = await GetConexionRechazosBySolicitud(idEntity);

            //solicitud.SolConexionAutogenReporteHallazgos = await GetReporteHallazgosBySolicitud(idEntity);

            //solicitud.SolConexionAutogenDesistimientos = await GetDesistimientosBySolicitud(idEntity);
        ...
        //}        
        public async Task<List<SolConexionAutogenInsumo>> GetInsumoBySolicitud(int idEntity)
        {
            return await _unitOfWork.SolConexionAutogenRepository.GetInsumosBySolicitud(idEntity);
        }
