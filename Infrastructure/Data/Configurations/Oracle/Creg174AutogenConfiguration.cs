namespace Infrastructure.Data.Configurations.Oracle
{
    ...
    public class Creg174AutogenConfiguration : IEntityTypeConfiguration<Creg174Autogen>
    {
        public void Configure(EntityTypeBuilder<Creg174Autogen> entity)
        {
            ...
            entity.HasOne(d => d.CodTipoIdentificacionNavigation)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("CREG_174_AUTOGEN_TIP_IDEN");
        }
    }
}
