...
{
    public class TipoCompletitudConfiguration : IEntityTypeConfiguration<TipoCompletitud>
    {
        public void Configure(EntityTypeBuilder<TipoCompletitud> entity)
        {
            entity.HasKey(e => e.Id);

            entity.ToTable("TipoCompletitud", "par");

            entity.Property(e => e.Id)
                .ValueGeneratedNever()
                .HasColumnName("IdTipoCompletitud");
