...
{
    public class TipoClaseCargaConfiguration : IEntityTypeConfiguration<TipoClaseCarga>
    {
        public void Configure(EntityTypeBuilder<TipoClaseCarga> entity)
        {
            entity.HasKey(e => e.Id);

            entity.ToTable("TipoClaseCarga", "par");

            entity.Property(e => e.Id)
                .HasComment("Identificación del registro")
                .HasColumnName("IdTipoClaseCarga");
