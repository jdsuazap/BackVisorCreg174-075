...
{
    public class SolServicioConexionAnexoConfiguration : IEntityTypeConfiguration<SolServicioConexionAnexo>
    {
        public void Configure(EntityTypeBuilder<SolServicioConexionAnexo> entity)
        {
            entity.HasKey(e => e.Id)
                    .HasName("PK_SolServicioConexionAdjuntos");

            entity.ToTable("SolServicioConexionAnexos", "sol");

            entity.Property(e => e.Id)
                .HasColumnName("IdSolServicioConexionAnexo")
            ...
            entity.Property(e => e.CodSolServicioConexion).HasComment("ID asociado a la solicitud del servicio conexión");
            ...
            entity.Property(e => e.CodUserUpdate)
                ...
                .IsUnicode(false)
                .HasDefaultValueSql("('7777777')")
                .HasComment("Cedula del último último que actualizó el registro");
            ...
            entity.Property(e => e.SendNotification).HasComment("Este campo indica si ya ha sido enviado correo electrónico con la notificacion del cambio");
