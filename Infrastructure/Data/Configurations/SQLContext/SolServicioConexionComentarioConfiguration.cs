...
{
    public class SolServicioConexionComentarioConfiguration : IEntityTypeConfiguration<SolServicioConexionComentario>
    {
        public void Configure(EntityTypeBuilder<SolServicioConexionComentario> entity)
        {
            entity.HasKey(e => e.Id)
                    .HasName("PK__SolConex__E2568D6A1C40E04D");

            entity.ToTable("SolServicioConexionComentario", "sol");

            entity.Property(e => e.Id)
                .HasColumnName("IdSolServicioConexionComentario");
            ...
            entity.Property(e => e.CodSolServicioConexion).HasComment("Codigo maestro de SolConexionAutogen");

            entity.Property(e => e.CodSolServicioConexionComentario).HasComment("Codigo padre al que pertenece este comentario, si es null, indica que es comentario padre de lo contrario es una respuesta a un comentario");
            ...
            entity.HasOne(d => d.CodEstadoSolicitudNavigation)
                .WithMany(p => p.SolServicioConexionComentarios)
                .HasForeignKey(d => d.CodEstadoSolicitud)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_SolServicioConexionComentario_Estado");

          

            entity.HasOne(d => d.CodSolServicioConexionComentarioNavigation)
                .WithMany(p => p.InverseCodSolServicioConexionComentarioNavigation)
                .HasForeignKey(d => d.CodSolServicioConexion)
                .HasConstraintName("FK_SolServicioConexionComentario_SolServicioConexionComentario");
