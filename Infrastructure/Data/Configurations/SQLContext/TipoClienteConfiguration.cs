...
namespace Infrastructure.Data.Configurations.SQLContext
{
    ...
    {
        public void Configure(EntityTypeBuilder<TipoCliente> entity)
        {
            entity.HasKey(e => e.Id)
                    .HasName("PK__TipoClie__F173C7FAD1B525F0");

            entity.ToTable("TipoCliente", "par");

            entity.Property(e => e.Id).HasColumnName("IdTipoCliente");
