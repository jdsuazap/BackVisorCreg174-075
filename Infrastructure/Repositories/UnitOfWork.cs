namespace Infrastructure.Repositories
{
    ...
    public class UnitOfWork : IUnitOfWork
    {
        ...
        public ITipoGeneracionRepository TipoGeneracionRepository => _tipoGeneracionRepository ?? new TipoGeneracionRepository(_eepContext,
              new DbConnectionFactorySingular(
                  _connections[EnumConnectionStrings.BaseDeDatoOracleEEP.ToString()]
              )
       );

        public IClasificacionProyectoRepository ClasificacionProyectoRepository => _clasificacionProyectoRepository ?? new ClasificacionProyectoRepository(_eepContext,
              new DbConnectionFactorySingular(
                  _connections[EnumConnectionStrings.BaseDeDatoOracleEEP.ToString()]
              )
       );

        public IComercializadorRepository ComercializadorRepository => _comercializadorRepository ?? new ComercializadorRepository(_eepContext,
             new DbConnectionFactorySingular(
                 _connections[EnumConnectionStrings.BaseDeDatoOracleEEP.ToString()]
             )
        );

        public ITipoIdentificacionRepository TipoIdentificacionRepository => _tipoIdentificacionRepository ?? new TipoIdentificacionRepository(_eepContext,
             new DbConnectionFactorySingular(
                 _connections[EnumConnectionStrings.BaseDeDatoOracleEEP.ToString()]
             )
        );

        public ITipoClienteRepository TipoClienteRepository => _tipoClienteRepository ?? new TipoClienteRepository(_eepContext,
            new DbConnectionFactorySingular(
                _connections[EnumConnectionStrings.BaseDeDatoOracleEEP.ToString()]
            )
        );

        public ITipoTecnologiaRepository TipoTecnologiaRepository => _tipoTecnologiaRepository ?? new TipoTecnologiaRepository(_eepContext,
           new DbConnectionFactorySingular(
               _connections[EnumConnectionStrings.BaseDeDatoOracleEEP.ToString()]
           )
        );

        public ITipoAerogeneradorRepository TipoAerogeneradorRepository => _tipoAerogeneradorRepository ?? new TipoAerogeneradorRepository(_eepContext,
           new DbConnectionFactorySingular(
               _connections[EnumConnectionStrings.BaseDeDatoOracleEEP.ToString()]
           )
        );

        public IEstratoSocioeconomicoRepository EstratoSocioeconomicoRepository => _estratoSocioeconomicoRepository ?? new EstratoSocioeconomicoRepository(_eepContext,
           new DbConnectionFactorySingular(
               _connections[EnumConnectionStrings.BaseDeDatoOracleEEP.ToString()]
           )
        );

        public ITipoTramiteVisitaRepository TipoTramiteVisitaRepository => _tipoTramiteVisitaRepository ?? new TipoTramiteVisitaRepository(_eepContext,
           new DbConnectionFactorySingular(
               _connections[EnumConnectionStrings.BaseDeDatoOracleEEP.ToString()]
           )
        );

        public ITipoClaseCargaRepository TipoClaseCargaRepository => _tipoClaseCargaRepository ?? new TipoClaseCargaRepository(_eepContext,
           new DbConnectionFactorySingular(
               _connections[EnumConnectionStrings.BaseDeDatoOracleEEP.ToString()]
           )
        );

        public ITipoCompletitudRepository TipoCompletitudRepository => _tipoCompletitudRepository ?? new TipoCompletitudRepository(_eepContext,
           new DbConnectionFactorySingular(
               _connections[EnumConnectionStrings.BaseDeDatoOracleEEP.ToString()]
           )
        );

        public ITipoConexionRepository TipoConexionRepository => _tipoConexionRepository ?? new TipoConexionRepository(_eepContext,
           new DbConnectionFactorySingular(
               _connections[EnumConnectionStrings.BaseDeDatoOracleEEP.ToString()]
           )
        );

        public ITipoConstruccionRepository TipoConstruccionRepository => _tipoConstruccionRepository ?? new TipoConstruccionRepository(_eepContext,
           new DbConnectionFactorySingular(
               _connections[EnumConnectionStrings.BaseDeDatoOracleEEP.ToString()]
           )
        );

        public ITipoPersonaRepository TipoPersonaRepository => _tipoPersonaRepository ?? new TipoPersonaRepository(_eepContext,
           new DbConnectionFactorySingular(
               _connections[EnumConnectionStrings.BaseDeDatoOracleEEP.ToString()]
           )
        );

        public ITipoProyectoRepository TipoProyectoRepository => _tipoProyectoRepository ?? new TipoProyectoRepository(_eepContext,
           new DbConnectionFactorySingular(
               _connections[EnumConnectionStrings.BaseDeDatoOracleEEP.ToString()]
           )
        );

        public ITipoServicioRepository TipoServicioRepository => _tipoServicioRepository ?? new TipoServicioRepository(_eepContext,
           new DbConnectionFactorySingular(
               _connections[EnumConnectionStrings.BaseDeDatoOracleEEP.ToString()]
           )
        );
        ...
        public ISolServicioConexionRepository SolServicioConexionRepository => _solServicioConexionRepository ?? new SolServicioConexionRepository(_eepContext,
           new DbConnectionFactorySingular(
               _connections[EnumConnectionStrings.BaseDeDatoOracleEEP.ToString()]
           )
        );

        public IEstadoRepository EstadoRepository => _estadoRepository ?? new EstadoRepository(_eepContext,
           new DbConnectionFactorySingular(
               _connections[EnumConnectionStrings.BaseDeDatoOracleEEP.ToString()]
           )
        );

        public IEmpresasRepository EmpresasRepository => _empresasRepository ?? new EmpresasRepository(_eepContext,
           new DbConnectionFactorySingular(
               _connections[EnumConnectionStrings.BaseDeDatoOracleEEP.ToString()]
           )
        );
        ...
        public ISolServicioConexionReciboTecnicoRepository SolServicioConexionReciboTecnicoRepository => _solServicioConexionReciboTecnicoRepository ?? new SolServicioConexionReciboTecnicoRepository(_eepContext,
           new DbConnectionFactorySingular(
               _connections[EnumConnectionStrings.BaseDeDatoOracleEEP.ToString()]
           )
        );
