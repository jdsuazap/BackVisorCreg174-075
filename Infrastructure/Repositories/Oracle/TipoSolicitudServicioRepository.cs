namespace Infrastructure.Repositories.Oracle
{
    ...
    public class TipoSolicitudServicioRepository : BaseRepositoryDapperOracle<CregTipoSolicitudServicio>, ITipoSolicitudServicioRepository
    {
        private readonly DbOracleContext _context;
        private readonly IDbConnectionFactory _dapperContext;

        public TipoSolicitudServicioRepository(
