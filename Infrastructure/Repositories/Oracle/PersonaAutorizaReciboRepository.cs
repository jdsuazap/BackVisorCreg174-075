namespace Infrastructure.Repositories.SQLContext
{
    ...
    public class PersonaAutorizaReciboRepository : BaseRepositoryDapperOracle<CregPersonaAutoriza>, IPersonaAutorizaReciboRepository
    {
        private readonly DbOracleContext _context;
        private readonly IDbConnectionFactory _dapperContext;

        public PersonaAutorizaReciboRepository(
