namespace Infrastructure.Repositories.Oracle
{
    ...
    public class TipoTramiteVisitaRepository : BaseRepositoryDapperOracle<CregTipoTramiteVisita>, ITipoTramiteVisitaRepository
    {
        private readonly DbOracleContext _context;
        private readonly IDbConnectionFactory _dapperContext;

        public TipoTramiteVisitaRepository(
